...
const RegisterPage: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterForm) => {
    try {
      setIsLoading(true);
      await registerUser(data.username, data.email, data.password, data.referralCode);
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold text-white mb-2">Join Win5x</h2>
          <p className="text-gold-400 text-lg font-semibold">Create your account</p>
          ...
          <div className="card-content">
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form-group">
                ...
                />
                {errors.referralCode && (
                  <p className="form-error">{errors.referralCode.message}</p>
                )}
              </div>
